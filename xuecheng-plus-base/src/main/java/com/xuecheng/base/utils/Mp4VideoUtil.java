...
public class Mp4VideoUtil extends VideoUtil {
    ...
    //上传文件路径
    String video_path = "D:\\VID20240229213311.mp4";
    //上传文件新名
    String mp4_name = "VID2024022921331.mp4";
    //转码后文件存储位置
    String mp4folder_path = "D:\\VID2024022921331.mp4";
...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        ...
        //源avi视频的路径
        String video_path = "D:\\VID20240229213311.avi";
        //转换后mp4文件的名称
        String mp4_name = "VID20240229213311.mp4";
        //转换后mp4文件的路径
        String mp4_path = "D:\\VID2024022921331.mp4";
        //创建工具类对象
